...
import { findParams, findNonEmptySolutions, countNodes, countTime, Model } from "./report";

export async function detailReportOption(dir: string, solPath: string) {
    ...
    diff.push({
        Solutions: { All_solved: {Number:fullSol,Models:fModels}, Partial_solved: {Number:parSol,Models:pModels}, No_solution: {Number:noSol,Models:nModels} }
    });
